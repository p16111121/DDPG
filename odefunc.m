...
Fext = ExternalAppliedForces(X,Y,Z,K,M,N,Props,velocities,angles);
...
dstates(7:9) = OCBMatrix(angles)*[states(1);states(2);states(3)];%速度轉換矩陣
dstates(10:12) = JMatrix(angles)*[states(4);states(5);states(6)];%角速度轉換矩陣
